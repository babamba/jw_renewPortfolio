    ...
    resumeStory: [
      {
        ...
        programLanguage: "React(TypeScript) / Mobx / AntDesign / Appsync(Apollo)",
        subDescriptions: [
          {
          ...
          {
            title: "Mobx를 이용한 Observer패턴 상태 관리 및 비즈니스 로직 분산 개발",
            type: "normal"
          },
          {
          ...
          {
            title: "디자이너의 와이어프레임을 참고하여 StoryBook 으로 UX / UI 문서화 진행",
            type: "normal"
          },
          {
      ...
      },
      {
        ...
        subDescriptions: [
          {
            title: "국립농업과학원 봉군형성실 iot Project의 web console 개발진행",
            type: "normal"
          },
          {
            title: "Flask / mysql 로 개발된 서버의 API 를 가지고 클라이언트 개발",
            type: "normal"
          },
          {
      ...
      },
      {
        ...
        subDescriptions: [
          ...
          {
            title: "위치 데이터 입출력 처리(csv 1만개 이상 데이터) 및 이동경로 지도 표시",
            type: "normal"
          }
        ]
      }
    ...
    resumeStory: [
      {
        ...
        subDescriptions: [
          ...
          {
            title: "관련 기사 https://www.mk.co.kr/news/special-edition/view/2018/12/777042/",
            type: "normal"
          }
        ]
      },
      {
        ...
        subDescriptions: [
          ...
          {
            title: "KT 셋탑 기가지니의 챗봇 관련 front 단 로직 및 UI/UX 적용 개발 진행",
            type: "normal"
          },
          {
      ...
      },
      {
        ...
        subDescriptions: [
          {
            title: "알티캐스트 - KT IPTV ACAP 셋탑 어플리케이션 모듈 키즈랜드 v2.0 안정화 프로젝트",
            type: "normal"
          },
          {
    ...
    resumeStory: [
      {
        ...
        subDescriptions: [
          ...
          {
            title: "리포팅 툴을 통한 관리자 통합 분석 및 보고서 제공(ClipReport 솔루션 사용)",
            type: "normal"
          },
          {
            title: "웹표준/웹접근성 관리",
      ...
      },
      {
        ...
        subDescriptions: [
          ...
          {
            title: "전자정부프레임워크, Tibero, ibatis, jQuery, Netfunnel, Dguard 사용",
            type: "normal"
          },
          {
            title:
