...
const to = i => ({ x: 0, y: i * -4, scale: 1, rot: -5 + Math.random() * 5, delay: i * 100 });
...
function Deck(Parent) {
  ...
  const [props, set] = useSprings(CardData.length, i => ({ ...to(i), from: from(i) })); // Create a bunch of springs using the helpers above
