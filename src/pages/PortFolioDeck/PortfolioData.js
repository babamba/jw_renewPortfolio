export default [
  {
    // 경기도시공사 프로젝트
    id: 'gicoapart',
    pics: require('../../assets/images/folio/mock_gico.png'),
  ...
  },
  {
    // 오산백년대학 프로젝트
    id: 'osan',
    pics: require('../../assets/images/folio/mock_osan.png'),
  ...
  },
  {
    // 키즈랜드
    id: 'kidsland',
    pics: require('../../assets/images/folio/mock_kids.png'),
    name: 'KT IPTV Middle Ware KidsLand Service v2',
    age: '2018.05 ~ 2019.09',
    distance: 'Complete',
    position: 'FrontEnd Javascript',
    titleDetail: '알티캐스트 & KT 셋탑 키즈랜드 2.0 프로젝트',
    stack: '주 사용 기술 : ES5 JavaScript',
    link: 'https://www.mk.co.kr/news/special-edition/view/2018/12/777042/',
    subDescriptions: [
  ...
  {
    id: 'beeapp',
    pics: require('../../assets/images/folio/mock_bee_app.png'),
    name: 'National Institute of Agricultural Sciences App',
    age: '2020.03 ~ 2020.06',
    distance: 'Complete',
    position: 'FrontEnd React',
    titleDetail: '국립농원과학원 봉군형성실 Mobile App 개발',
    stack: '주 사용 기술 : React Native(ES6 JavaScript) / Mobx / Victory Chart',
    link: '',
    subDescriptions: [
  ...
  {
    id: 'beeweb',
    pics: require('../../assets/images/folio/mock_bee_web.png'),
  ...
  {
    id: 'telematices',
    pics: require('../../assets/images/folio/mock_tele.png'),
    ...
    link: 'http://gint-telematics-console.s3-website.ap-northeast-2.amazonaws.com/',
    subDescriptions: [
