          ...
          <Timeline>
                  ...
                  >
                    <HeadDiv>
                      <motion.div variants={ItemStyle}>
                        <Avatar shape="circle" size={50} src="/static/images/company/gint.png" />
                      </motion.div>
                      ...
                      <DescBox>
                        ...
                        <motion.div variants={ItemStyle}>
                          <PositionText>서비스플랫폼 선임 연구원</PositionText>
                        </motion.div>
                      </DescBox>
                    </HeadDiv>
                    <Row>
                      <Col span={24}>
                        <ProjectBox>
                          <motion.div variants={ItemStyle}>
                            <JobMainText>
                              <StatusBadge status="processing" /> Gint Connect Telematics 플랫폼
                              개발 (2019.12 ~ 현재)
                            </JobMainText>
                            <JobText>
                              ...
                              <Text underline strong>
                                React SPA Application 개발환경 부터 S3 Bucket Product 환경
                              </Text>
                              까지 구성 및 개발 진행 <br />- React / Amplify / Ant design /
                              styled-components 등 사용 <br />- AppSync(GraphQL) 을 통한
                              Subscription 기반 소켓통신 및 실시간 알림 및 실시간 데이터 변경 처리{' '}
                              <br />- AppSync VTL 코드 작성 <br />
                              - Mobx를 이용한 상태 관리 및 비즈니스 로직 분산 개발. - ApexChart를
                              이용한 통계 관련 Data Visualization <br />- GitLab CI / CD 를 통한
                              Docker Container build test / e2e test / Deploy PipeLine 작성 및
                              자동화 구성 <br />- AWS S3 / CloudFront를 이용한 프로덕션 빌드 결과물
                          ...
                          <motion.div variants={ItemStyle}>
                            <JobMainText>
                              <StatusBadge status="success" /> 국립농원과학원 봉군형성실 Web Console
                              개발( 2020.01 ~ 현재 )
                            </JobMainText>
                            <JobText>
                              - 국립농업과학원 봉군형성실 iot Project의 web console 개발진행 <br />
                          ...
                          <motion.div variants={ItemStyle}>
                            <JobMainText>
                              <StatusBadge status="success" /> 국립농원과학원 봉군형성실 Mobile App
                              개발(2020.03 ~ 2020.06)
                            </JobMainText>
                            <JobText>
                          ...
                          <JobMainText>
                            <StatusBadge status="success" /> 충남대학교 농업동력 테스트
                            프로젝트(2020.02 ~ 2020.03)
                          </JobMainText>
                          <JobText>
                            - 충남대학교 트랙터 동력 테스트 Web console 개발 <br />- Aws lambda /
                            sqs 서비스를 이용해 제작된 API를 가지고 클라이언트 개발 <br />- 위치
                            데이터 입출력 처리(csv 1만개 이상 데이터) 및 이동경로 지도 표시 <br />
                            - 데이터 관리 및 실험 관리 개발
                            <br />-{' '}
                            <Text underline strong>
                              React / Ant.Design
            ...
            <Timeline.Item>
              <Card style={{ borderRadius: 12 }}>
                ...
                <ContentBox>
                  <HeadDiv>
                    <Avatar shape="circle" size={50} src="/static/images/company/xhift.png" />
                    <DescBox>
                      <CompanyText>XHIFT</CompanyText>
                      {/* <DescriptionText>(서울시)</DescriptionText> */}
                      <div>
                  ...
                  <Row>
                    <Col span={24}>
                      <ProjectBox>
                        <JobMainText>
                          <StatusBadge status="success" /> 알티캐스트 & KT 셋탑 키즈랜드 2.0
                        ...
                        <JobMainText>
                          <StatusBadge status="success" /> KT 기가지니 "미봇" 테스트용 프로젝트 POC
                          프로젝트 (2018.05 ~ 2018.10)
                        </JobMainText>
                        <JobText>
                          - KT 기가지니 "미봇" 테스트용 프로젝트 POC 진행
                          <br />- KT 셋탑 기가지니의 챗봇 관련 front 단 로직 및 UI/UX 적용 개발 진행
                        ...
                        <JobMainText>
                          <StatusBadge status="success" /> 알티캐스트 & KT 셋탑 Voice UI
                        ...
                        <JobMainText>
                          <StatusBadge status="success" /> 알티캐스트 & KT 셋탑 키즈랜드 2.0 고도화
                          프로젝트(2018.12 ~ 2019.04)
                        </JobMainText>
                        <JobText>
        ...
        Technical testing 2015-09-01
            ...
            <Timeline.Item>
              <Card style={{ borderRadius: 12 }}>
                ...
                <ContentBox>
                  <HeadDiv>
                    <Avatar shape="circle" size={50} src="/static/images/company/nanumict.png" />
                    <DescBox>
                  ...
                  <Row>
                    <Col span={24}>
                      <ProjectBox>
                        <JobMainText>
                          <StatusBadge status="success" /> 오산시 공공기관 오산백년 시민대학 시스템
                          구축 프로젝트(2017.04~2018.01)
                        </JobMainText>
                        <JobText>
                          -{' '}
                          ...
                          8. 사용자 권한 별 관리 기능 제공
                          <br />
                          9. 클라이언트 접속 지연시간 튜닝(무거워진 메인/상세 페이지 소스/라이브러리
                          관리) <br />
                          10. 관리자 시스템 개발(배너, 게시물 관리, 사업관리, 권한 관리, 통계, 접속
                          로그, 회원관리, 예약관리, 공통코드관리
                          <br />
                          ...
                          <br />
                          14. 웹표준/웹접근성 관리(퍼블리셔가 중국인인 이유로 본인이 관리)
                          <br />
                        </JobText>
                        ...
                        <JobMainText>
                          <StatusBadge status="success" /> 경기도시공사 인터넷청약시스템 구축
                          프로젝트(2017.12 ~2018.04)
                        </JobMainText>
                        <JobText>
                          -{' '}
                          ...
                          인터넷시스템으로 구축 <br />
                          - 전자정부프레임워크, Tibero, ibatis, jQuery,Netfunnel,Dguard <br />
                          - 12월 중순 1차 인터넷 청약신청시스템 선 구축 후 운영 및 실시간 데이터를
                          통한
                          <br />
                          - 경쟁률 및 현황 분석을 제공 및 민원사항 수렴 후 빠른 조치 제공
                          <br />
                          - 분석단계 SH/LH 컨설팅 및 선진사례도출 &gt; RFP, 제안서 기반 요구사항 /
                          추적표 / 과업대비표 / 도메인정의 도출 &gt; 설계단계
                          <br />
                          – 유즈케이스 / 화면UI설계서 자료 도출
            ...
            <Timeline.Item>
              <Card style={{ borderRadius: 12 }}>
                ...
                <ContentBox>
                  <HeadDiv>
                    <Avatar shape="circle" size={50} src="/static/images/company/bit_logo.png" />
                    <DescBox>
                      <CompanyText>비트 캠프</CompanyText>
                      {/* <DescriptionText>(수원)</DescriptionText> */}
                      <div>
                        <PositionText>JAVA 기반 웹표준/웹프로그래밍 개발자 양성과정</PositionText>
                      </div>
                    </DescBox>
                  </HeadDiv>
                  <Row>
                    <Col span={24}>
                      <ProjectBox>
                        <JobMainText>
                          <StatusBadge status="success" /> 웹 서버 & 클라이언트 프로그래밍 과정
                          수료(2016.09 ~ 2017.03)
                        </JobMainText>
                        ...
                        <JobText>
                          - 응용 애플리케이션 개발과정 습득
                          <br />
                          - 졸업프로젝트 : HOT DOG(Pet Cam : Raspberry Pi를 이용한 웹/앱 스트리밍 및
                          커뮤니티) <br />-{' '}
                          ...
                          <br />
                          - 주 업무 : 프론트엔드 개발 <br />
                          - 사용기술 : Spring / MyBatis / Maria DB / Jquery <br />
                        </JobText>
                      </ProjectBox>
                    </Col>
                  </Row>
            ...
            <Timeline.Item>
              <Card style={{ borderRadius: 12 }}>
                ...
                <ContentBox>
                  <HeadDiv>
                    <Avatar shape="circle" size={50} src="/static/images/company/gico.png" />
                    <DescBox>
                  ...
                  <Row>
                    <Col span={24}>
                      <ProjectBox>
                        <JobMainText>
                          <StatusBadge status="success" /> 사내 홈페이지 고도화 (2015.08 ~2016.06)
                        </JobMainText>
                        ...
                        <CustomDivider />
                        <JobMainText>
                          <StatusBadge status="success" /> 홍보실 사무 (2014.06 ~2015.08)
                        </JobMainText>
            ...
            <Timeline.Item>
              <Card style={{ borderRadius: 12 }}>
                ...
                <ContentBox>
                  <HeadDiv>
                    <Avatar shape="circle" size={50} src="/static/images/company/doja.png" />
                    <DescBox>
            ...
            <Timeline.Item>
              <Card style={{ borderRadius: 12 }}>
                ...
                <ContentBox>
                  <HeadDiv>
                    <Avatar shape="circle" size={50} src="/static/images/company/knu.png" />
                    <DescBox>
