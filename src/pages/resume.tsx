                          ...
                          <ProjectBox>
                            <motion.div variants={ItemStyle}>
                              ...
                              <JobText>
                                ...
                                까지 구성 및 개발 진행 <br />- React / Amplify /
                                Ant design / styled-components 등 사용 <br />-
                                AppSync(GraphQL) 을 통한 Subscription 기반
                                소켓통신 및 실시간 알림 및 실시간 데이터 변경
                                처리 <br />- AppSync VTL 코드 작성 <br />
                                - Mobx를 이용한 상태 관리 및 비즈니스 로직 분산
                                개발. - ApexChart를 이용한 통계 관련 Data
                                Visualization <br />- GitLab CI / CD 를 통한
                                Docker Container build test / e2e test / Deploy
                                PipeLine 작성 및 자동화 구성 <br />- AWS S3 /
                                CloudFront를 이용한 프로덕션 빌드 결과물 배포{" "}
                                <br />- Cypress를 이용한 e2e test code 작성 및
                                테스트 자동화 <br />- 디자이너의 와이어프레임을
                                참고하여 StoryBook 으로 UX / UI 문서화 진행.{" "}
                                <br />- 서비스 기획 회의 및 요구사항도출 문서화{" "}
                                <br />
                              </JobText>
                            </motion.div>
                            <CustomDivider />
                            ...
                            <motion.div variants={ItemStyle}>
                              ...
                              <JobText>
                                - 국립농업과학원 봉군형성실 iot Project의 web
                                console 개발진행 <br />- Flask / mysql 로 개발된
                                서버의 API 를 가지고 클라이언트 개발 <br />-{" "}
                                <Text underline strong>
                                  React / Material-UI
                                </Text>
                                로 개발. <br />- 실시간 데이터 fetching 처리 및
                            ...
                            <JobText>
                              ...
                              <br />- Aws lambda / sqs 서비스를 이용해 제작된
                              API를 가지고 클라이언트 개발 <br />- 위치 데이터
                              입출력 처리(csv 1만개 이상 데이터) 및 이동경로
                              지도 표시 <br />
                              - 데이터 관리 및 실험 관리 개발
                              <br />-{" "}
                              <Text underline strong>
                    ...
                    <Row>
                      <Col span={24}>
                        <ProjectBox>
                          ...
                          <JobMainText>
                            <StatusBadge status="success" /> KT 기가지니 "미봇"
                            테스트용 프로젝트 POC 프로젝트 (2018.05 ~ 2018.10)
                          </JobMainText>
                          <JobText>
                            - KT 기가지니 "미봇" 테스트용 프로젝트 POC 진행
                            <br />- KT 셋탑 기가지니의 챗봇 관련 front 단 로직
                            및 UI/UX 적용 개발 진행
                            <br />- 셋탑 사양 대비 애니메이션 추가로 인한 효율적
                            소스 관리
                          </JobText>
                          ...
                          <JobMainText>
                            <StatusBadge status="success" /> 알티캐스트 & KT
                            셋탑 키즈랜드 2.0 고도화 프로젝트(2018.12 ~ 2019.04)
                          </JobMainText>
                          <JobText>
                      ...
                      <Col span={24}>
                        <ProjectBox>
                          ...
                          <JobText>
                            ...
                            <br />
                            7. 시멘틱(의미 기반) 검색/분석 시스템 구축(Konan
                            Search 솔루션 사용)
                            <br />
                            8. 사용자 권한 별 관리 기능 제공
                            <br />
                            9. 클라이언트 접속 지연시간 튜닝(무거워진 메인/상세
                            페이지 소스/라이브러리 관리) <br />
                            10. 관리자 시스템 개발(배너, 게시물 관리, 사업관리,
                            권한 관리, 통계, 접속 로그, 회원관리, 예약관리,
                            공통코드관리
                            <br />
                            11. 플랫폼 중심의 강사, 활동가, 수강생 간의 연계
                            네트워크 구성)
                            <br />
                            12. 형상 관리(SVN), 젠킨스(Maven빌드 tomcat war
                            redeploy)
                            <br />
                            13. 리포팅 툴을 통한 관리자 통합 분석 및 보고서
                            제공(ClipReport)
                            <br />
                            14. 웹표준/웹접근성 관리
                            <br />
                      ...
                      <Col span={24}>
                        <ProjectBox>
                          ...
                          <JobText>
                            ...
                            <br />
                            - 주 업무 : 프론트엔드 개발 <br />
                            - 사용기술 : Spring / MyBatis / Maria DB / Jquery{" "}
                            <br />
                          </JobText>
                        </ProjectBox>
                      </Col>
                  ...
                  <ContentBox>
                    ...
                    <Row>
                      <Col span={24}>
                        <ProjectBox>
                          <JobMainText>
                            <StatusBadge status="success" /> 경기도 지원
                            교육기부사업 진행 및 운영
                          </JobMainText>
