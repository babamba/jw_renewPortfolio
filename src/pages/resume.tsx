                          ...
                          <ProjectBox>
                            <motion.div variants={ItemStyle}>
                              ...
                              <JobText>
                                ...
                                자동화 구성 <br />- AWS S3 / CloudFront를 이용한 프로덕션 빌드
                                결과물 배포 <br />- Cypress를 이용한 e2e test code 작성 및 테스트
                                자동화 <br />- 디자이너의 와이어프레임을 참고하여 StoryBook 으로 UX
                                / UI 문서화 진행. <br />- 서비스 기획 회의 및 요구사항도출 문서화{' '}
                                <br />
                              </JobText>
                            </motion.div>
                            <CustomDivider />
                            ...
                            <motion.div variants={ItemStyle}>
                              <JobMainText>
                                <StatusBadge status="success" /> 국립농원과학원 봉군형성실 Web
                            ...
                            <motion.div variants={ItemStyle}>
                              <JobMainText>
                                <StatusBadge status="success" /> 국립농원과학원 봉군형성실 Mobile
                  ...
                  <ContentBox>
                    ...
                    <Row>
                      <Col span={24}>
                        <ProjectBox>
                          <JobMainText>
                            <StatusBadge status="success" /> 오산시 공공기관 오산백년 시민대학
                            시스템 구축 프로젝트(2017.04~2018.01)
                          </JobMainText>
                          <JobText>
                            -{' '}
