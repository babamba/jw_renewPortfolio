                      ...
                      <HeadDiv>
                        ...
                        <DescBox>
                          ...
                          <motion.div variants={ItemStyle}>
                            ...
                            <PositionText> 프론트엔드 개발자(Client)</PositionText>
                          </motion.div>
                        </DescBox>
                      </HeadDiv>
                      <Row>
                      ...
                      <Row>
                        <Col span={24}>
                          <ProjectBox>
                            ...
                            <JobMainText>
                              <StatusBadge status="success" /> KT 기가지니 "미봇" POC 프로젝트
                              (2018.05 ~ 2018.10)
                            </JobMainText>
                            <JobText>
                              - {''}
                            ...
                            <JobText>
                              ...
                              <br />
                              - 알티캐스트 - KT IPTV ACAP 셋탑 어플리케이션 모듈 키즈랜드 v2.0
                              안정화 프로젝트
                      ...
                      <HeadDiv>
                        ...
                        <DescBox>
                          ...
                          <motion.div variants={ItemStyle}>
                            ...
                            <Divider style={{ borderWidth: 3 }} type="vertical" />
                            <Text strong>포지션 :</Text>
                            <PositionText> 풀스택 개발자(Server & Client)</PositionText>
                          </motion.div>
                        </DescBox>
                      </HeadDiv>
                      <Row>
                        <Col span={24}>
                          <ProjectBox>
                            ...
                            <JobText>
                              ...
                              <br />- {''}
                              <Text underline strong>
                                개발언어 : Spring MVC / Ibatis / HTML & CSS & JQuery
                              </Text>
                              <br />
                              - 요구사항 도출 및 화면 설계
                              <br />
                            ...
                            <JobText>
                              ...
                              - 12월 중순 1차 인터넷 청약신청시스템 선 구축 후 운영 및 실시간
                              데이터를 통한
                              <br />
                        ...
                        <Col span={24}>
                          <ProjectBox>
                            ...
                            <JobText>
                              ...
                              - 응용 애플리케이션 개발과정 습득
                              <br />
                              - 졸업프로젝트 : HOT DOG(Pet Cam : Raspberry Pi를 이용한 웹/앱
                              스트리밍 및 커뮤니티) <br />
                            </JobText>
                          </ProjectBox>
                        </Col>
                    ...
                    >
                      ...
                      <Row>
                        <Col span={24}>
                          <ProjectBox>
                            <JobMainText>
                              <StatusBadge status="success" /> 사내 홈페이지 고도화 (2015.08
                              ~2016.06)
                            </JobMainText>
